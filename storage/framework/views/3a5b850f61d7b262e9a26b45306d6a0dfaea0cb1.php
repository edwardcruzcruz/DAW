    	...
    	<div class="col-sm-9">
			...
			<div class="tab-content">
	            ...
	            <div class="tab-pane active" id="home">
					...
					<?php echo e(Form::model(Session::get('usuario.0'), array('url' => array('updateClient',Session::get('usuario.0.id')), 'method' => 'PUT'))); ?>
...
<?php echo e(Form::text('Correo', Input::old('Correo'), array('class' => 'form-control'))); ?>
        ...
        <?php echo e(Form::text('CI', Input::old('CI'), array('class' => 'form-control'))); ?>
						...
						<div class="form-group">
						  <div class="col-xs-6">
						      <?php echo e(Form::label('NombreEmpresa', 'Empresa o Institucion')); ?>
