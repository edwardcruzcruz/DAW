...
<div id="cuerpo" class="container bootstrap snippet">
            ...
            <div class="row">
                ...
                <div  id="menulado" class="col-sm-3"><!--left col-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="<?php echo e(URL::to('editar/'. Session::get('usuario.0.id') )); ?>" class="btn btn-danger btn-block btn-compose-email">Editar Perfil</a>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-xs-12 col-sm-8">
                                       <ul class="list-group">
                                          <li class="list-group-item"><?php echo e(Session::get('usuario.0.Nombre','No existe sesion')); ?></li>
                                          <li class="list-group-item"><?php echo e(Session::get('usuario.0.Profesion','No existe sesion')); ?></li>
                                          <li class="list-group-item"><?php echo e(Session::get('usuario.0.NombreEmpresa','No existe sesion')); ?> </li>
                                          <li class="list-group-item"><i class="fa fa-phone"></i><?php echo e(Session::get('usuario.0.Telefono','No existe sesion')); ?> </li>
                                          <li class="list-group-item"><i class="fa fa-envelope"></i><?php echo e(Session::get('usuario.0.Correo','No existe sesion')); ?></li>
                                       </ul>
                                    </div>
                                </div>
                            </div>
