...
<?php $__env->startSection('content'); ?>
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="d-block w-100" src="<?php echo e(asset('img/bg1.jpg')); ?>" alt="First slide">
		...
		<div class="carousel-item">
			<img class="d-block w-100" src="<?php echo e(asset('img/bg3.jpg')); ?>" alt="First slide">
		</div>
	...
	<div class="row padding">
		...
		<div class="col-lg-6">
			<img src="<?php echo e(asset('img/codehouse_win1.jpeg')); ?>" class="img-fluid">
		</div>
	</div>
	</div>
	...
	<div class="row padding">
		<div class="col-md-6">
			<div class="card">
				<img class="card-img-top" src="<?php echo e(asset('img/man.png')); ?>">
				<div class="card-body">
	...
	<div class="row text-center padding">
	<div class="col-12">
		<img src="<?php echo e(asset('img/black.png')); ?>" class="img-fluid">
	</div>
	</div>
	<div class="row text-center padding">
	<div class="col-12">
