            ...
            <div class="row">
                ...
                <div  id="menulado" class="col-sm-3"><!--left col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <ul class="list-group">
                            <li class="list-group-item text-right"><span class="pull-left"><strong>Proyectos</strong></span> <?php echo e(count(Session::get('solicitudes'))); ?></li>
...
<?php echo e(Form::open(['url' => 'guardarPropuesta','method'=>'post'])); ?>
...
<?php echo e(Form::submit('Crear un nueva Propuesta', array('class' => 'btn btn-primary'))); ?>
