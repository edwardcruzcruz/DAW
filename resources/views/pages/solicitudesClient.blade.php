...
<div id="cuerpo" class="container bootstrap snippet">
            ...
            <div class="row">
                ...
                <div  id="menulado" class="col-sm-3"><!--left col-->
                    ...
                    <div class="row">
                        <div id="user" class="col-sm-3"><h1>{{Session::get('usuario.0.Nombre')}}</h1></div>
                ...
                <div class="col-sm-9">
                	...
                	<table class="table table-inbox table-hover">
                            <tbody>
			    @foreach(Session::get('solicitudes') as $solicitud)
                              <tr class="">
                                  <td class="view-message"><h5>{{$solicitud->Titulo}}</h5><br><p>{{$solicitud->Descripcion}}</p></td>
                                  <td class="view-message inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                                  <td class="view-message text-right">{{$solicitud->Fecha}}</td>
                                  <td class="view-message"><h5>Estado</h5><br><p>{{$solicitud->Estado}}</p></td>
